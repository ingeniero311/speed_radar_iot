...
static int taskSpeedTimeout(struct pt *pt) {
    ...
    while (1) {
        do { (pt)->lc = 46; case 46:; if(!(isMuxing)) { return 0; } } while(0);
        delay = millis() + 1000;
        do { (pt)->lc = 48; case 48:; if(!(millis() >= delay)) { return 0; } } while(0);
        isMuxing = 0;
        do { ((&ptSubTask))->lc = 0;; do { ((((pt))))->lc = 50; case 50:; if(!(!((((updateDigits(&ptSubTask, "0"))) < 2)))) { return 0; } } while(0); } while(0);
...
static int taskReadRadarSpeed(struct pt *pt) {
    ...
    __nop();
    while (1) {
        do { (pt)->lc = 68; case 68:; if(!(UART1_is_rx_ready())) { return 0; } } while(0);
        while (UART1_is_rx_ready()) {
            charRx = UART1_Read();

            bufferRx[indexRx++] = charRx;
            do { PT_YIELD_FLAG = 0; (pt)->lc = 73; case 73:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
            if (charRx == 0x0A) {
                ...
                do { PT_YIELD_FLAG = 0; (pt)->lc = 80; case 80:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
                ...
                if (strcmp(bufferRx, "0") == 0) {
                    do { ((&ptSubTask))->lc = 0;; do { ((((pt))))->lc = 93; case 93:; if(!(!((((updateDigits(&ptSubTask, bufferRx))) < 2)))) { return 0; } } while(0); } while(0);
                    memset(bufferRx, 0, sizeof (bufferRx));
                    indexRx = 0;
                    do { PT_YIELD_FLAG = 0; (pt)->lc = 96; case 96:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
                    continue;
                }

                if (strcmp(bufferRx, "00") == 0) {
                    do { ((&ptSubTask))->lc = 0;; do { ((((pt))))->lc = 101; case 101:; if(!(!((((updateDigits(&ptSubTask, bufferRx))) < 2)))) { return 0; } } while(0); } while(0);
                    memset(bufferRx, 0, sizeof (bufferRx));
                    indexRx = 0;
                    do { PT_YIELD_FLAG = 0; (pt)->lc = 104; case 104:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
                    continue;
                }

                if (strcmp(bufferRx, "000") == 0) {
                    do { ((&ptSubTask))->lc = 0;; do { ((((pt))))->lc = 109; case 109:; if(!(!((((updateDigits(&ptSubTask, bufferRx))) < 2)))) { return 0; } } while(0); } while(0);
                    memset(bufferRx, 0, sizeof (bufferRx));
                    indexRx = 0;
                    do { PT_YIELD_FLAG = 0; (pt)->lc = 112; case 112:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
                    continue;
                }


                isMuxing = 1;
                do { ((&ptSubTask))->lc = 0;; do { ((((pt))))->lc = 118; case 118:; if(!(!((((updateDigits(&ptSubTask, bufferRx))) < 2)))) { return 0; } } while(0); } while(0);

                if (strlen(txVelStr) != 0) {
                    do { PT_YIELD_FLAG = 0; (pt)->lc = 121; case 121:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
                    strcat(txVelStr, "|");
                }
                strcat(txVelStr, bufferRx);
                velCount++;
                do { PT_YIELD_FLAG = 0; (pt)->lc = 126; case 126:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);

                memset(bufferRx, 0, sizeof (bufferRx));
                indexRx = 0;
                do { PT_YIELD_FLAG = 0; (pt)->lc = 130; case 130:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
            } else if (indexRx > 5) {
                memset(bufferRx, 0, sizeof (bufferRx));
                indexRx = 0;
                do { PT_YIELD_FLAG = 0; (pt)->lc = 134; case 134:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
            }
        }
    }
    }; PT_YIELD_FLAG = 0; (pt)->lc = 0;; return 3; };
...
static int taskTestRadar(struct pt *pt) {
    ...
    for (i = 0; i <= 120; i += 11) {
        delay = millis() + 200;
        do { (pt)->lc = 155; case 155:; if(!(millis() > delay)) { return 0; } } while(0);
        __asm(" clrwdt");
        ...
        __nop();
        isMuxing = 1;
        do { ((&ptSubTask))->lc = 0;; do { ((((pt))))->lc = 172; case 172:; if(!(!((((updateDigits(&ptSubTask, finalSpeed))) < 2)))) { return 0; } } while(0); } while(0);
    }
    do { ((&ptSubTask))->lc = 0;; do { ((((pt))))->lc = 174; case 174:; if(!(!((((updateDigits(&ptSubTask, "000"))) < 2)))) { return 0; } } while(0); } while(0);
    while (1) {
        do { PT_YIELD_FLAG = 0; (pt)->lc = 176; case 176:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
    }
    }; PT_YIELD_FLAG = 0; (pt)->lc = 0;; return 3; };
}
...
static int taskTimeout(struct pt *pt) {
    ...
    while (1) {
        ...
        do { (pt)->lc = 196; case 196:; if(!(((millis() > delay) || (strlen(txVelStr) >= speedBufferLen)))) { return 0; } } while(0);
        ...
        if (strlen(txVelStr) == 0) {
            ...
            do { do { (pt)->lc = 205; case 205:; if(!((&mutexUart2Tx)->count > 0)) { return 0; } } while(0); --(&mutexUart2Tx)->count; } while(0);

            sendUart2Str("AT+GTDAT=gv300,0,,[ASR100|DS|1.0|EVT|SRP");
            sendUart2Str("|");
            ...
            delay = millis() + 2000;
            do { (pt)->lc = 218; case 218:; if(!(millis() >= delay)) { return 0; } } while(0);
            ++(&mutexUart2Tx)->count;
        }
    }
    }; PT_YIELD_FLAG = 0; (pt)->lc = 0;; return 3; };
