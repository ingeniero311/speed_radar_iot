...
static int taskShowDigt(struct pt *pt) {
    ...
    while (1) {
        ...
        LATCbits.LATC0 = digits[0].segA;
        LATCbits.LATC1 = digits[0].segB;
        LATCbits.LATC2 = digits[0].segC;
        LATCbits.LATC3 = digits[0].segD;
        LATCbits.LATC4 = digits[0].segE;
        LATCbits.LATC5 = digits[0].segF;
        LATCbits.LATC6 = digits[0].segG;




        _delay((unsigned long)((15)*(64000000/4000000.0)));
        do { LATBbits.LATB4 = 1; } while(0);

        delay = millis() + 2;
        do { (pt)->lc = 184; case 184:; if(!(millis() > delay)) { return 0; } } while(0);
        ...
        LATCbits.LATC0 = digits[1].segA;
        LATCbits.LATC1 = digits[1].segB;
        LATCbits.LATC2 = digits[1].segC;
        LATCbits.LATC3 = digits[1].segD;
        LATCbits.LATC4 = digits[1].segE;
        LATCbits.LATC5 = digits[1].segF;
        LATCbits.LATC6 = digits[1].segG;
        _delay((unsigned long)((15)*(64000000/4000000.0)));
        do { LATBbits.LATB5 = 1; } while(0);
        delay = millis() + 2;
        do { (pt)->lc = 202; case 202:; if(!(millis() > delay)) { return 0; } } while(0);
        do { LATBbits.LATB5 = 0; } while(0);
        _delay((unsigned long)((5)*(64000000/4000000.0)));



        LATCbits.LATC0 = digits[2].segA;
        LATCbits.LATC1 = digits[2].segB;
        LATCbits.LATC2 = digits[2].segC;
        LATCbits.LATC3 = digits[2].segD;
        LATCbits.LATC4 = digits[2].segE;
        LATCbits.LATC5 = digits[2].segF;
        LATCbits.LATC6 = digits[2].segG;
        _delay((unsigned long)((15)*(64000000/4000000.0)));
        ...
        do { PT_YIELD_FLAG = 0; (pt)->lc = 225; case 225:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
    }
...
int updateDigits(struct pt *pt, char *vel) {
    ...
    static signed char newDigit1;
    static signed char newDigit2;
    static signed char newDigit3;
    ...
    if (strlen(vel) == 1) {
        newDigit1 = 0;
        newDigit2 = 0;
        newDigit3 = (signed char) (vel[2] - '0');
        digtS = 1;
        do { PT_YIELD_FLAG = 0; (pt)->lc = 257; case 257:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);

    } else if (strlen(vel) == 2) {
        newDigit1 = 0;
        newDigit2 = (signed char) (vel[1] - '0');
        newDigit3 = (signed char) (vel[2] - '0');
        digtS = 2;
        __nop();
        do { PT_YIELD_FLAG = 0; (pt)->lc = 265; case 265:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);

    } else if (strlen(vel) == 3) {

        newDigit1 = (signed char) (vel[0] - '0');
        newDigit2 = (signed char) (vel[1] - '0');
        newDigit3 = (signed char) (vel[2] - '0');

        __nop();
        if (newDigit1 == 0 && newDigit2 == 0 && newDigit3 == 0) {
            digtS = 0;
            do { PT_YIELD_FLAG = 0; (pt)->lc = 276; case 276:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
            updateEachdigit(&digits[0], -1);
            updateEachdigit(&digits[1], -1);
            updateEachdigit(&digits[2], -1);
        } else if (newDigit1 == 0 && newDigit2 == 0 && newDigit3 > 0) {
            digtS = 1;
            do { PT_YIELD_FLAG = 0; (pt)->lc = 282; case 282:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
            updateEachdigit(&digits[0], -1);
            updateEachdigit(&digits[1], -1);
            updateEachdigit(&digits[2], newDigit3);
        } else if (newDigit1 == 0 && newDigit2 > 0) {
            digtS = 2;
            do { PT_YIELD_FLAG = 0; (pt)->lc = 288; case 288:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
            updateEachdigit(&digits[0], -1);
            updateEachdigit(&digits[1], newDigit2);
            updateEachdigit(&digits[2], newDigit3);

        } else if (newDigit1 > 0) {
            do { PT_YIELD_FLAG = 0; (pt)->lc = 294; case 294:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
            char numericChar[15];
            char ackStr[20];

            fin = (newDigit1 * 100) + (newDigit2 * 10) + newDigit3;





            do { PT_YIELD_FLAG = 0; (pt)->lc = 304; case 304:; if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
            digtS = 3;
            updateEachdigit(&digits[0], newDigit1);
            updateEachdigit(&digits[1], newDigit2);
            updateEachdigit(&digits[2], newDigit3);
        }
